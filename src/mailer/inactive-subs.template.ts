...
export const getInactiveSubsTemplate = (user: string) => `
<!doctype html>
<html>
  <body>
    <div
          ...
          <tr style="width:100%">
            <td>
              ...
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                A Copa está se aproximando e percebemos que você se cadastrou em
                nosso bolão, mas ainda não ativou seu cadastro!
              </div>
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                ⚠️ Para garantir sua vaga e começar a dar seus palpites, você
                deve efetuar o pagamento da inscrição no valor de R$100,00 até o
                dia 10/06, às 23h59.
              </div>
              ...
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                The World Cup is just around the corner, and we noticed that you
                registered for our pool but haven’t activated your account yet!
              </div>
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
...
/* 
{
  ...
  "block-1778750403549": {
    ...
    "data": {
      ...
      "props": {
        "text": "A Copa está se aproximando e percebemos que você se cadastrou em nosso bolão, mas ainda não ativou seu cadastro!"
      }
    }
  },
  "block-1778750521811": {
  ...
  "block-en-para1": {
    ...
    "data": {
      ...
      "props": {
        "text": "The World Cup is just around the corner, and we noticed that you registered for our pool but haven’t activated your account yet!"
      }
    }
  },
  "block-en-para2": {
  ...
  "block-1779811753218-986": {
    ...
    "data": {
      ...
      "props": {
        "text": "⚠️ Para garantir sua vaga e começar a dar seus palpites, você deve efetuar o pagamento da inscrição no valor de R$100,00 até o dia 10/06, às 23h59."
      }
    }
  },
  "block-1779811847150": {
